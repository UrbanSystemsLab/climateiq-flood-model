...
```
docker run -it -v $(pwd)/climateiq-flood-simulation-input:/mnt/disks/share/climateiq-flood-simulation-input -v $(pwd)/climateiq-flood-simulation-output:/mnt/disks/share/climateiq-flood-simulation-output -v $(pwd)/climateiq-citycat-config:/mnt/disks/share/climateiq-flood-simulation-config citycat-image:latest 
```
...
```
docker run -it --entrypoint bash -v $(pwd)/climateiq-flood-simulation-input:/mnt/disks/share/climateiq-flood-simulation-input -v $(pwd)/climateiq-flood-simulation-output:/mnt/disks/share/climateiq-flood-simulation-output -v $(pwd)/climateiq-citycat-config:/mnt/disks/share/climateiq-flood-simulation-config citycat-image:latest
```
